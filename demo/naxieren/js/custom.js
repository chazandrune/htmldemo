...
//联系弹窗函数
function tanchucontact(){
	var tccontact = layer.open({
		type: 1,
		title: false,
		closeBtn: false,
		fix: true,
	...
	$('.tc-closebtn').on('click',function(){
		layer.close(tccontact);
	})
}

//上传弹窗函数
function tanchuupload(){
	var tcupload = layer.open({
		type: 1,
		title: false,
		closeBtn: false,
		fix: true,
	...
	$('.tc-closebtn').on('click',function(){
		layer.close(tcupload);
	})
}


//弹窗函数
function tanchuerweima(){
	var erweima = layer.open({
		type: 1,
		title: false,
		closeBtn: false,
		fix: false,

...
$(function(){
	...
	//导航额外效果
	$(".con_nav .hassub").hover(function(){
		$(".con_body").stop(true,true).animate({marginLeft:"200px",opacity:".5"},300);
		$(".con_body").addClass("blur");
	},function(){
		$(".con_body").delay(300).animate({marginLeft:"0px",opacity:"1"},300);
		$(".con_body").removeClass("blur");
	})
	...
	//主体关闭并移除
	$(".close_con_body").click(function(){
		$(this).parent(".con_body").stop(true,true).animate({
